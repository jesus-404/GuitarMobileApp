...
public class OneMinChangeActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_min_change);

        startTimer();
        startTimeSpent = System.currentTimeMillis();

        Button closeBtn = findViewById(R.id.one_min_close_btn);
        closeBtn.setOnClickListener(v -> {
            Intent intent = new Intent(OneMinChangeActivity.this, HomeActivity.class);
    ...
    private void startTimer() {
        TextView oneMinTimer = findViewById(R.id.one_min_timer);
