...
public class ChordBuilderActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button closeBtn = findViewById(R.id.chord_builder_btn);
        closeBtn.setOnClickListener(v -> {
            Intent intent = new Intent(ChordBuilderActivity.this, HomeActivity.class);
    ...
    private void startTimer() {
        TextView oneMinTimer = findViewById(R.id.chord_builder_timer);
